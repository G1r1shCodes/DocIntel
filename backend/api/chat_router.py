...
async def process_chat_query(
    ...
    system_prompt = (
        ...
        "8. Look carefully through ALL provided sources for field synonyms (e.g. 'passenger' or 'pax' for 'traveller', 'place of work', 'office', or city for 'location'). If present under any synonym in ANY source, extract it accurately.\n"
        "9. If the CONTEXT truly has no answer after checking all sources, say exactly: Not found in the document.\n"
